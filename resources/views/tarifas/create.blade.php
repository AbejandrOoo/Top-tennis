                    ...
                    <form action="{{ route('tarifas.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <input type="number" name="precio_hora" step="0.01" min="0" placeholder="Ej: 50.00" required class="w-full border border-gray-300 rounded-xl py-3 px-4 text-sm font-medium focus:border-[#7cb518] focus:ring-[#7cb518] transition shadow-sm">
                            </div>
                        </div>

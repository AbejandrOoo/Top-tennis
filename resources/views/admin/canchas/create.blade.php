                ...
                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('admin.canchas.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" class="w-full border border-gray-300 rounded-xl py-3 px-4 text-sm font-medium focus:border-[#7cb518] focus:ring-[#7cb518] transition shadow-sm" placeholder="Ej: Cancha Central N°1" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                <label class="block text-[#0b3b24] text-sm font-black mb-2">Estado:</label>
                                <select name="estado" required class="w-full border border-gray-300 rounded-xl py-3 px-4 text-sm font-medium focus:border-[#7cb518] focus:ring-[#7cb518] transition shadow-sm">
